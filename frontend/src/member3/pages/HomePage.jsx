...
/** Served from `public/images/help-bg3.png` (same origin as CRA). */
const HERO_BG = `${process.env.PUBLIC_URL || ""}/images/help-bg3.png`;
...
export default function HomePage() {
  ...
  const handleSearch = (e) => {
    ...
    if (!trimmed) {
      navigate(`${M3}/featured`);
      return;
    }

    navigate(`${M3}/featured?search=${encodeURIComponent(trimmed)}`);
  };
      ...
      <style>{`
        * {
        ...
        .hero {
          width: 100%;
          height: 420px;
          background-image: url(${JSON.stringify(HERO_BG)});
...
<div className="action-grid">
  ...
  <div className="action-card" onClick={() => navigate(`${M3}/report`)}>
  ...
  <div className="action-card" onClick={() => navigate(`${M3}/my-reports`)}>
    <div className="action-icon">
      <svg viewBox="0 0 24 24">
        <path d="M9 4h6"/>
  ...
  <div className="action-card" onClick={() => navigate(`${M3}/featured`)}>
    <div className="action-icon">
      <svg viewBox="0 0 24 24">
